...
* Clean clears out the local repository of retrieved package files.
  apt clean
* Install aptoncd_0.1.98%2Btelolet_all.deb with gdebi
  sudo gdebi aptoncd_0.1.98%2Btelolet_all.deb
* Create app.iso MUST with aptoncd (telolet version)
* Change wesnoth with app your name in setup.sh in line DEBIAN_FRONTEND=gnome apt install -y wesnoth
* Customize free.xml (change vendor,product, version, location, etc ) 
  edit with InstallBuilder
